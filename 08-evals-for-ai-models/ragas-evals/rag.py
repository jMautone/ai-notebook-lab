...
DOCUMENTS = [
    "La Revolución Industrial (1760-1840) fue un período de transformación económica y social que comenzó en Gran Bretaña. Marcó el cambio de economías agrícolas a industriales mediante la mecanización de la manufactura. Provocó la migración masiva de trabajadores rurales a ciudades, creando la clase obrera moderna. Aunque aumentó la producción de bienes, también generó condiciones laborales precarias, contaminación ambiental y desigualdad social. El sistema capitalista moderno surgió de este período.",
    "La fotosíntesis es el proceso mediante el cual las plantas convierten luz solar, agua y dióxido de carbono en glucosa y oxígeno. Ocurre principalmente en las hojas, en estructuras llamadas cloroplastos. El proceso tiene dos fases: la reacción luminosa (en la membrana de tilacoides) donde se genera ATP y NADPH usando energía de la luz, y el ciclo de Calvin (en el estroma) donde se sintetiza la glucosa a partir del CO2. Es fundamental para la vida en la Tierra pues produce oxígeno y alimento.",
    "El cambio climático es el aumento a largo plazo de las temperaturas globales principalmente debido a las actividades humanas. Las causas principales incluyen: emisiones de gases de efecto invernadero (CO2, metano, N2O) por quema de combustibles fósiles, deforestación, ganadería intensiva e industria manufacturera. Estos gases atrapan calor en la atmósfera mediante el efecto invernadero. Las consecuencias incluyen aumento del nivel del mar, eventos climáticos extremos más frecuentes, extinción de especies y disrupciones en la producción agrícola. Las evidencias científicas muestran que el 97% de los climatólogos están de acuerdo.",
    "Ada Lovelace (1815-1852) fue una matemática inglesa pionera en computación. Trabajó con Charles Babbage en su Máquina Analítica, una precursora de las computadoras modernas. En 1843 escribió el primer algoritmo pensado para ser procesado por una máquina, ganándose el título de 'primer programador del mundo'. Sus notas sobre la máquina fueron más extensas que el artículo original de Babbage, demostrando una comprensión profunda de la lógica computacional que anticipó conceptos de programación modernos (como loops y funciones) más de un siglo antes de que existieran computadoras electrónicas reales.",
    "El ejercicio regular proporciona numerosos beneficios para la salud física y mental. Mejora la función cardiovascular incrementando la capacidad del corazón y reduciendo la presión arterial, aumenta la resistencia muscular y flexibilidad, ayuda a mantener un peso saludable y reduce el riesgo de enfermedades crónicas como diabetes tipo 2, hipertensión arterial y algunos cánceres. Psicológicamente, el ejercicio reduce estrés y depresión, mejora el estado de ánimo mediante la liberación de endorfinas, fortalece la función cognitiva y reduce el riesgo de demencia. Las directrices de salud mundial recomiendan 150 minutos de actividad aeróbica moderada por semana para adultos, complementados con ejercicios de resistencia."
]
